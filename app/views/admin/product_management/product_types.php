...
<head>
    ...
    <title><?php echo $pageTitle ?? 'Quản lý Loại sản phẩm'; ?></title>
...
<body>
    ...
    <div class="management-container">
        ...
        <div class="management-header">
            ...
            <p>Thêm, sửa, xóa các loại sản phẩm</p>

            <div class="action-buttons">
                <a href="index.php?page=admin_product&section=product_types&action=add" class="btn btn-primary">
        ...
        <div class="data-table">
            <?php if ($productTypes && $productTypes->num_rows > 0): ?>
                <table class="table">
                    ...
                    <tbody>
                        <?php 
                        $stt = 1;
                        while ($productType = $productTypes->fetch_assoc()): 
                        ?>
                            <tr>
                                <td><?php echo $stt++; ?></td>
                                <td>
                                    <strong><?php echo htmlspecialchars($productType['loaisanpham_ten']); ?></strong>
                                </td>
                                <td>
                                    <strong><?php echo htmlspecialchars($productType['danhmuc_ten']); ?></strong>
                                </td>
                                <td>
                                ...
                                <td style="text-align: center;">
                                    <a href="index.php?page=admin_product&section=product_types&action=edit&id=<?php echo $productType['loaisanpham_id']; ?>" 
            ...
            <?php else: ?>
                <div class="no-data">
                    ...
                    <p>Hãy thêm loại sản phẩm đầu tiên cho sản phẩm của bạn</p>
                    <a href="index.php?page=admin_product&section=product_types&action=add" class="btn btn-primary">
