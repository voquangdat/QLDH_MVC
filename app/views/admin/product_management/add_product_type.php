...
<body>
    ...
    <div class="admin-header">
        <div class="container">
            <h1><i class="fas fa-plus"></i> Thêm loại sản phẩm</h1>
    ...
    <div class="form-container">
        ...
        <div class="form-header">
            ...
            <p>Tạo loại sản phẩm mới cho hệ thống sản phẩm</p>
        </div>
        ...
        <div class="form-wrapper">
            <div class="form-help">
                ...
                <strong>Hướng dẫn:</strong> Loại sản phẩm sẽ là nhóm chính để phân loại sản phẩm trong danh mục.
                Sau khi tạo loại sản phẩm, bạn có thể thêm các sản phẩm cụ thể vào loại này.
            </div>
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" 
                           ...
                           value="<?php echo htmlspecialchars($_POST['loaisanpham_ten'] ?? ''); ?>"
                           required>
                </div>
