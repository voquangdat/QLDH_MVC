...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 30, 2025 lúc 06:36 PM
...
--
-- Cơ sở dữ liệu: `website_voxfootball1`
--
...
CREATE TABLE `tbl_admin` (
  ...
  `idgroup` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'o la thanh vien , 1 la admin ',
...
INSERT INTO `tbl_admin` (`admin_id`, `admin_name`, `admin_password`, `idgroup`, `email`, `full_name`, `status`, `created_at`, `last_login`, `last_password_change`) VALUES
(1, 'admin', '12345678', 1, NULL, NULL, 'active', '2025-09-24 19:15:23', '2025-09-27 04:12:04', NULL),
(2, 'hoainam', '12345678', 0, NULL, NULL, 'active', '2025-09-24 19:15:23', NULL, NULL),
(3, 'dat', 'Dat227889#', 1, NULL, NULL, 'active', '2025-09-24 19:15:23', '2025-09-30 16:12:41', NULL);
...
CREATE TABLE `tbl_cart` (
  ...
  `quantitys` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `tbl_cart` (`cart_id`, `customer_id`, `sanpham_anh`, `session_idA`, `sanpham_id`, `bienthe_id`, `sanpham_tieude`, `sanpham_gia`, `quantitys`) VALUES
(303, NULL, '/public/uploads/68d9a45dbed48.jpg', '50l84n04cd5a646l3qv7au4l6s', 82, 8, 'Bộ quần áo bóng đá CLB Arsenal Đỏ sân nhà 2024-2025', 145000.00, 1);
...
(80, 'admin/uploads/8d3f4e41f6.jpg', 'l2l94der298vml2nntcu350qdf', 47, 'Bộ quần áo bóng đá CLB Arsenal Đỏ sân nhà 2023 120.000 VND', '120000', 'admin/uploads/1c576a1548.png', '1', 'XL'),
(81, 'admin/uploads/d9cdbc9909.jpg', 'l2l94der298vml2nntcu350qdf', 48, 'Bộ quần áo bóng đá CLB Mancity Đen 2023', '120000', 'admin/uploads/54a1da2419.jpg', '1', 'L');
...
(2, 'ĐEN', '54a1da2419.jpg'),
(8, 'XANH', '9e34b56377.png'),
(9, 'ĐỎ ', '1c576a1548.png'),
(10, 'TRẮNG ', 'd9c8f4f341.png'),
(11, 'XÁM ', '28709c4cf8.jpg'),
(12, 'CAM ', '50fb811c9a.png'),
(13, 'TRẮNG HỒNG', '7101b65810.jpg'),
(14, 'VÀNG ', '24594572cf.png');
...
INSERT INTO `tbl_customers` (`customer_id`, `username`, `email`, `password_hash`, `full_name`, `phone`, `address`, `city`, `district`, `ward`, `birth_date`, `gender`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Quachdatpy78', 'voquangdat03072004@gmail.com', '$2y$10$3j9vt0Vwb7RajhWamqn/EuEnkMcempGFTnWbdwhE9KvvVwbl6pC8e', 'Quachdatpy78', '', NULL, NULL, NULL, NULL, NULL, NULL, 'active', '2025-09-24 23:57:57', '2025-09-30 13:06:23'),
(2, 'da', 'pbk020204@gmail.com', '$2y$10$qV/2CYS6AR2Od0p8TANf0O4XEgxX.mytNrC/yiephWGvQ90CwR.dy', 'da', '', NULL, NULL, NULL, NULL, NULL, NULL, 'active', '2025-09-25 00:13:50', '2025-09-25 00:14:26'),
(3, 'Khoa', 'voquangdat@gmail.com', '$2y$10$fhQdRmystAwxn66j0VPLuuGgDzDq95V1.fj8VFd2D//M7TFlpPEaa', 'Khoa', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', '2025-09-25 00:22:12', '2025-09-25 00:22:28'),
(4, '0903527632', '0903527632@temp.voxfootball.com', '$2y$10$JPZ6QAvHxW63ZjFgs5vX9etA2Lz..N/dqVNrPu5RFlJ8gAD7Mz2Qe', 'võ quang đạt', '0903527632', 'sadsad', NULL, NULL, NULL, NULL, NULL, 'active', '2025-09-25 18:58:47', '2025-09-25 18:58:47'),
(5, 'demo', 'demo@test.com', '$2y$10$lg2yk./dB9HcgFkwLfiTQeFBTUISLxX8ARkUHM6Sn9Cv1/HwK3xLm', 'demo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', '2025-09-30 12:07:11', '2025-09-30 12:07:33'),
(6, 'đạt', 'dat37@gmail.com', '$2y$10$UneVxo6B/ThJROhJbKjqC.rr12mJQr.R.crY0af1CJuwYSdZJMHA2', 'đạt', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'active', '2025-09-30 16:02:34', '2025-09-30 16:02:55');
...
--
-- Cấu trúc bảng cho bảng `tbl_momo_transaction_log`
--

CREATE TABLE `tbl_momo_transaction_log` (
  `log_id` int(11) NOT NULL,
  `payment_id` int(11) DEFAULT NULL,
  `transaction_type` enum('request','return','notify') NOT NULL,
...
INSERT INTO `tbl_order` (`order_id`, `order_code`, `customer_id`, `session_idA`, `loaikhach`, `customer_name`, `customer_phone`, `customer_tinh`, `customer_huyen`, `customer_xa`, `customer_diachi`, `order_status`, `payment_status`, `order_date`, `total_amount`, `created_at`, `shipping_fee`) VALUES
(125, 'VFB000125', NULL, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'giang', '0903527632', '52', '548', '21874', '402', 'delivered', 'paid', '2025-09-30 11:49:01', 120000.00, '2025-09-30 04:49:01', 0.00),
(126, 'VFB000126', NULL, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'giang', '0903527632', '52', '545', '21778', '402', 'delivered', 'paid', '2025-09-30 11:50:07', 120000.00, '2025-09-30 04:50:07', 0.00),
(127, 'VFB000127', NULL, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'giang', '0903527632', '52', '545', '21772', '402', 'delivered', 'unpaid', '2025-09-30 12:05:22', 120000.00, '2025-09-30 05:05:22', 0.00),
(128, 'VFB000128', NULL, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'giang', '0903527632', '52', '550', '21961', '402', 'delivered', 'unpaid', '2025-09-30 12:12:34', 120000.00, '2025-09-30 05:12:34', 0.00),
(129, 'VFB000129', NULL, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'giang', '0903527632', '52', '545', '21742', '402', 'cancelled', 'unpaid', '2025-09-30 12:18:02', 120000.00, '2025-09-30 05:18:02', 0.00),
(130, 'VFB000130', NULL, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'testmomo', '0903527632', '60', '597', '23065', '160', 'delivered', 'unpaid', '2025-09-30 12:55:47', 120000.00, '2025-09-30 05:55:47', 0.00),
(131, 'VFB000131', NULL, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'testmomo', '0903527632', '52', '548', '21895', '402', 'cancelled', 'unpaid', '2025-09-30 12:58:29', 120000.00, '2025-09-30 05:58:29', 0.00),
(132, 'VFB000132', NULL, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'testmomo', '0903527632', '60', '601', '23257', '160', 'delivered', 'unpaid', '2025-09-30 13:10:30', 120000.00, '2025-09-30 06:10:30', 0.00),
(135, 'VFB000135', NULL, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'testmomo', '0903527632', '60', '597', '23071', '402', 'delivered', 'paid', '2025-09-30 13:23:49', 120000.00, '2025-09-30 06:23:49', 0.00),
(136, 'VFB000136', NULL, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'giang', '0903527632', '70', '698', '25240', '160', 'delivered', 'paid', '2025-09-30 13:27:24', 120000.00, '2025-09-30 06:27:24', 0.00),
(138, 'VFB000138', 1, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'vo', '0903527632', '27', '259', '09268', '160 Huỳnh Thị Hai', 'delivered', 'unpaid', '2025-09-30 16:55:43', 120000.00, '2025-09-30 09:55:43', 0.00),
(139, 'VFB000139', 1, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'giang', '0903527632', '60', '597', '23071', '402', 'cancelled', 'unpaid', '2025-09-30 17:24:06', 120000.00, '2025-09-30 10:24:06', 0.00),
(141, 'VFB000141', NULL, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'giang', '0903527632', '96', '971', '32191', '402', 'pending', 'unpaid', '2025-09-30 18:26:33', 145000.00, '2025-09-30 11:26:33', 0.00),
(142, 'VFB000142', NULL, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'testmomo', '0903527632', '52', '545', '21742', '402', 'delivered', 'paid', '2025-09-30 18:44:00', 150000.00, '2025-09-30 11:44:00', 0.00),
(143, 'VFB000143', NULL, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'demo', '0903527632', '96', '971', '32203', '402', 'delivered', 'paid', '2025-09-30 19:08:12', 100000.00, '2025-09-30 12:08:12', 0.00),
(144, 'VFB000144', 1, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'giang', '0903527632', '89', '890', '30502', '402', 'pending', 'paid', '2025-09-30 20:08:11', 120000.00, '2025-09-30 13:08:11', 0.00),
(145, 'VFB000145', 6, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'võ quang đạt', '0903527632', '79', '761', '26776', '160 Huỳnh Thị Hai', 'delivered', 'unpaid', '2025-09-30 23:05:12', 690000.00, '2025-09-30 16:05:12', 0.00),
(146, 'VFB000146', 6, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'võ quang đạt', '0903527632', '70', '689', '25204', '160 Huỳnh Thị Hai', 'delivered', 'paid', '2025-09-30 23:09:16', 120000.00, '2025-09-30 16:09:16', 0.00),
(147, 'VFB000147', 6, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'giang', '0903527632', '83', '834', '29002', '160 Huỳnh Thị Hai', 'cancelled', 'unpaid', '2025-09-30 23:11:13', 150000.00, '2025-09-30 16:11:13', 0.00),
(148, 'VFB000148', 6, 'rim58t16jfkj7vd81s0m7l0mhq', 'khachle', 'giang', '0903527632', '04', '049', '01582', '160 Huỳnh Thị Hai', 'processing', 'paid', '2025-09-30 23:27:27', 230000.00, '2025-09-30 16:27:27', 0.00);
...
CREATE TABLE `tbl_order_details` (
  ...
  `order_id` int(11) NOT NULL,
  `sanpham_id` int(11) NOT NULL,
  `bienthe_id` int(11) DEFAULT NULL,
  `sanpham_tieude` varchar(255) NOT NULL,
  `sanpham_anh` varchar(255) NOT NULL,
  `sanpham_gia` decimal(10,2) NOT NULL,
...
INSERT INTO `tbl_order_details` (`detail_id`, `order_id`, `sanpham_id`, `bienthe_id`, `sanpham_tieude`, `sanpham_anh`, `sanpham_gia`, `quantity`, `subtotal`) VALUES
(31, 125, 88, 77, 'Áo bóng đá Chelsea xanh sân nhà 25/26', '/public/uploads/68db1c5c22d28.png', 120000.00, 1, 120000.00),
(32, 126, 88, 75, 'Áo bóng đá Chelsea xanh sân nhà 25/26', '/public/uploads/68db1c5c22d28.png', 120000.00, 1, 120000.00),
(33, 127, 87, 70, 'Áo bóng đá MU đỏ sân nhà 25/26', '/public/uploads/68db1c17058cd.png', 120000.00, 1, 120000.00),
(34, 128, 43, 50, 'Quần áo Manchester City xanh sân nhà 25/26', '/public/uploads/68db196b150b5.jpg', 120000.00, 1, 120000.00),
(35, 129, 88, 75, 'Áo bóng đá Chelsea xanh sân nhà 25/26', '/public/uploads/68db1c5c22d28.png', 120000.00, 1, 120000.00),
(36, 130, 87, 71, 'Áo bóng đá MU đỏ sân nhà 25/26', '/public/uploads/68db1c17058cd.png', 120000.00, 1, 120000.00),
(37, 131, 84, 55, 'Áo bóng đá Arsenal xanh đen sân khách 25/26', '/public/uploads/68db1a4259dd4.png', 120000.00, 1, 120000.00),
(38, 132, 84, 55, 'Áo bóng đá Arsenal xanh đen sân khách 25/26', '/public/uploads/68db1a4259dd4.png', 120000.00, 1, 120000.00),
(41, 135, 88, 75, 'Áo bóng đá Chelsea xanh sân nhà 25/26', '/public/uploads/68db1c5c22d28.png', 120000.00, 1, 120000.00),
(42, 136, 88, 75, 'Áo bóng đá Chelsea xanh sân nhà 25/26', '/public/uploads/68db1c5c22d28.png', 120000.00, 1, 120000.00),
(44, 138, 85, 60, 'Áo bóng đá Liverpool đỏ sân nhà 25/26', '/public/uploads/68db1aeb51fce.jpg', 120000.00, 1, 120000.00),
(45, 139, 87, 70, 'Áo bóng đá MU đỏ sân nhà 25/26', '/public/uploads/68db1c17058cd.png', 120000.00, 1, 120000.00),
(47, 141, 82, 8, 'Bộ quần áo bóng đá CLB Arsenal Đỏ sân nhà 2024-2025', '/public/uploads/68d9a45dbed48.jpg', 145000.00, 1, 145000.00),
(48, 142, 80, 1, 'Bộ quần áo bóng đá CLB Arsenal Đỏ sân nhà 2024-2025', '/public/uploads/68d999f90cf69.jpg', 150000.00, 1, 150000.00),
(49, 143, 72, 45, 'Áo bóng đá Arsenal đỏ sân nhà 25/26', '/public/uploads/68db1922be2e3.png', 100000.00, 1, 100000.00),
(50, 144, 87, 70, 'Áo bóng đá MU đỏ sân nhà 25/26', '/public/uploads/68db1c17058cd.png', 120000.00, 1, 120000.00),
(51, 145, 88, 75, 'Áo bóng đá Chelsea xanh sân nhà 25/26', '/public/uploads/68db1c5c22d28.png', 120000.00, 1, 120000.00),
(52, 145, 87, 70, 'Áo bóng đá MU đỏ sân nhà 25/26', '/public/uploads/68db1c17058cd.png', 120000.00, 1, 120000.00),
(53, 145, 86, 65, 'Áo bóng đá Liverpool trắng sân khách 25/26', '/public/uploads/68db1b3722aed.png', 150000.00, 3, 450000.00),
(54, 146, 88, 75, 'Áo bóng đá Chelsea xanh sân nhà 25/26', '/public/uploads/68db1c5c22d28.png', 120000.00, 1, 120000.00),
(55, 147, 86, 65, 'Áo bóng đá Liverpool trắng sân khách 25/26', '/public/uploads/68db1b3722aed.png', 150000.00, 1, 150000.00),
(56, 148, 91, 85, 'Áo bóng đá Barca sân nhà 25/26 hàng Thái Lan', '/public/uploads/68dc02e9388fe.png', 230000.00, 1, 230000.00);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tbl_order_status_history`
--
...
--
-- Đang đổ dữ liệu cho bảng `tbl_order_status_history`
--

INSERT INTO `tbl_order_status_history` (`id`, `order_id`, `old_status`, `new_status`, `note`, `actor_admin_id`, `created_at`) VALUES
(17, 127, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 05:07:13'),
(18, 127, 'confirmed', 'processing', 'Bắt đầu xử lý đơn hàng', 3, '2025-09-30 05:07:18'),
(19, 127, 'processing', 'delivered', 'Hoàn tất giao hàng và xuất kho', 3, '2025-09-30 05:07:57'),
(20, 126, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 05:08:09'),
(21, 126, 'confirmed', 'processing', 'Bắt đầu xử lý đơn hàng', 3, '2025-09-30 05:08:22'),
(22, 126, 'processing', 'delivered', 'Hoàn tất giao hàng và xuất kho', 3, '2025-09-30 05:08:32'),
(23, 128, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 05:14:06'),
(24, 128, 'confirmed', 'processing', 'Bắt đầu xử lý đơn hàng', 3, '2025-09-30 05:14:10'),
(25, 128, 'processing', 'delivered', 'Hoàn tất giao hàng và xuất kho', 3, '2025-09-30 05:14:40'),
(26, 125, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 05:15:22'),
(27, 125, 'confirmed', 'delivered', 'Hoàn tất giao hàng và xuất kho', 3, '2025-09-30 05:15:25'),
(28, 129, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 05:18:21'),
(29, 129, 'confirmed', 'processing', 'Bắt đầu xử lý đơn hàng', 3, '2025-09-30 05:18:37'),
(30, 129, 'processing', 'cancelled', 'Huỷ đơn hàng: khách không nhận hàng ', 3, '2025-09-30 05:19:17'),
(31, 130, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 05:56:13'),
(32, 130, 'confirmed', 'delivered', 'Hoàn tất giao hàng và xuất kho', 3, '2025-09-30 05:56:20'),
(33, 131, 'pending', 'cancelled', 'Huỷ đơn hàng: hủy\\r\\n', 3, '2025-09-30 05:59:06'),
(34, 132, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 06:10:41'),
(35, 132, 'confirmed', 'delivered', 'Hoàn tất giao hàng và xuất kho', 3, '2025-09-30 06:10:43'),
(36, 136, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 06:32:40'),
(37, 136, 'confirmed', 'delivered', 'Hoàn tất giao hàng và xuất kho', 3, '2025-09-30 06:32:43'),
(38, 135, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 06:32:48'),
(39, 135, 'confirmed', 'delivered', 'Hoàn tất giao hàng và xuất kho', 3, '2025-09-30 06:32:50'),
(41, 139, 'cancelled', 'cancelled', 'Khách hàng hủy đơn: âsd', NULL, '2025-09-30 10:30:51'),
(42, 142, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 12:05:50'),
(43, 142, 'confirmed', 'delivered', 'Hoàn tất giao hàng và xuất kho', 3, '2025-09-30 12:05:54'),
(44, 143, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 12:10:53'),
(45, 143, 'confirmed', 'processing', 'Bắt đầu xử lý đơn hàng', 3, '2025-09-30 12:10:58'),
(46, 143, 'processing', 'delivered', 'Hoàn tất giao hàng và xuất kho', 3, '2025-09-30 12:11:04'),
(47, 138, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 13:00:15'),
(48, 138, 'confirmed', 'delivered', 'Hoàn tất giao hàng và xuất kho', 3, '2025-09-30 13:00:40'),
(49, 145, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 16:07:36'),
(50, 145, 'confirmed', 'processing', 'Bắt đầu xử lý đơn hàng', 3, '2025-09-30 16:07:47'),
(51, 145, 'processing', 'delivered', 'Hoàn tất giao hàng và xuất kho', 3, '2025-09-30 16:08:09'),
(52, 146, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 16:10:05'),
(53, 146, 'confirmed', 'processing', 'Bắt đầu xử lý đơn hàng', 3, '2025-09-30 16:10:23'),
(54, 146, 'processing', 'delivered', 'Hoàn tất giao hàng và xuất kho', 3, '2025-09-30 16:10:37'),
(55, 147, 'cancelled', 'cancelled', 'Khách hàng hủy đơn: bận', NULL, '2025-09-30 16:12:02'),
(56, 148, 'pending', 'confirmed', 'Xác nhận đơn hàng và giữ hàng', 3, '2025-09-30 16:34:08'),
(57, 148, 'confirmed', 'processing', 'Bắt đầu xử lý đơn hàng', 3, '2025-09-30 16:34:16');
...
INSERT INTO `tbl_payment` (`payment_id`, `order_id`, `session_idA`, `delivery_method`, `payment_method`, `amount`, `transaction_id`, `payment_date`, `payment_status`, `created_at`, `updated_at`) VALUES
(80, 125, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thu tiền tận nơi', 120000.00, NULL, '2025-09-30 11:49:07', 'completed', '2025-09-30 04:49:07', '2025-09-30 04:49:07'),
(81, 126, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thu tiền tận nơi', 120000.00, NULL, '2025-09-30 11:50:11', 'completed', '2025-09-30 04:50:11', '2025-09-30 04:50:11'),
(82, 127, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thu tiền tận nơi', 120000.00, NULL, '2025-09-30 12:06:49', 'completed', '2025-09-30 05:06:49', '2025-09-30 05:07:57'),
(83, 128, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thu tiền tận nơi', 120000.00, NULL, '2025-09-30 12:12:37', 'completed', '2025-09-30 05:12:37', '2025-09-30 05:14:40'),
(84, 129, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thu tiền tận nơi', 120000.00, NULL, '2025-09-30 12:18:06', 'pending', '2025-09-30 05:18:06', '2025-09-30 05:18:06'),
(85, 130, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thanh toán Momo', 120000.00, NULL, '2025-09-30 12:55:53', 'pending', '2025-09-30 05:55:53', '2025-09-30 05:55:53'),
(86, 131, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thanh toán Momo', 120000.00, NULL, '2025-09-30 12:58:35', '', '2025-09-30 05:58:35', '2025-09-30 06:09:36'),
(87, 132, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thanh toán Momo', 120000.00, NULL, '2025-09-30 13:10:34', 'pending', '2025-09-30 06:10:34', '2025-09-30 06:11:04'),
(90, 135, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thanh toán bằng thẻ ATM(OnePay)', 120000.00, NULL, '2025-09-30 13:24:03', 'completed', '2025-09-30 06:24:03', '2025-09-30 06:24:03'),
(91, 136, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thanh toán Momo', 120000.00, NULL, '2025-09-30 13:27:27', 'completed', '2025-09-30 06:27:27', '2025-09-30 06:31:26'),
(92, 138, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thu tiền tận nơi', 120000.00, NULL, '2025-09-30 16:56:12', 'completed', '2025-09-30 09:56:12', '2025-09-30 13:00:40'),
(93, 139, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thu tiền tận nơi', 120000.00, NULL, '2025-09-30 17:24:11', 'pending', '2025-09-30 10:24:11', '2025-09-30 10:24:11'),
(94, 141, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thu tiền tận nơi', 145000.00, NULL, '2025-09-30 18:34:02', 'pending', '2025-09-30 11:34:02', '2025-09-30 11:34:02'),
(95, 142, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thanh toán Momo', 150000.00, NULL, '2025-09-30 18:44:10', 'completed', '2025-09-30 11:44:10', '2025-09-30 11:59:39'),
(96, 143, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thanh toán Momo', 100000.00, NULL, '2025-09-30 19:08:30', 'completed', '2025-09-30 12:08:30', '2025-09-30 12:08:57'),
(97, 144, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thanh toán bằng thẻ ATM(OnePay)', 120000.00, NULL, '2025-09-30 20:08:19', 'completed', '2025-09-30 13:08:19', '2025-09-30 13:08:19'),
(98, 145, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thu tiền tận nơi', 690000.00, NULL, '2025-09-30 23:06:25', 'completed', '2025-09-30 16:06:25', '2025-09-30 16:08:09'),
(99, 146, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thanh toán bằng thẻ ATM(OnePay)', 120000.00, NULL, '2025-09-30 23:09:24', 'completed', '2025-09-30 16:09:24', '2025-09-30 16:09:24'),
(100, 147, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thu tiền tận nơi', 150000.00, NULL, '2025-09-30 23:11:22', 'pending', '2025-09-30 16:11:22', '2025-09-30 16:11:22'),
(101, 148, 'rim58t16jfkj7vd81s0m7l0mhq', 'Giao hàng chuyển phát nhanh', 'Thanh toán bằng thẻ ATM(OnePay)', 230000.00, NULL, '2025-09-30 23:27:36', 'completed', '2025-09-30 16:27:36', '2025-09-30 16:27:36');
...
CREATE TABLE `tbl_sanpham` (
  ...
  `color_id` int(11) NOT NULL,
  `sanpham_gia` decimal(10,2) NOT NULL,
  `sanpham_giakhuyenmai` int(11) DEFAULT NULL,
  `sanpham_chitiet` text NOT NULL,
  `sanpham_baoquan` text NOT NULL,
  `sanpham_anh` varchar(255) NOT NULL,
  `sanpham_anhkhac` varchar(255) DEFAULT NULL,
  `sanpham_hot` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `tbl_sanpham` (`sanpham_id`, `sanpham_tieude`, `sanpham_ma`, `danhmuc_id`, `loaisanpham_id`, `color_id`, `sanpham_gia`, `sanpham_giakhuyenmai`, `sanpham_chitiet`, `sanpham_baoquan`, `sanpham_anh`, `sanpham_anhkhac`, `sanpham_hot`) VALUES
(43, 'Quần áo Manchester City xanh sân nhà 25/26', 'VFO0001', 1, 1, 8, 120000.00, 150000, '<ul>\r\n	<li>Th&acirc;n &aacute;o in chuyển nhiệt đẹp</li>\r\n	<li>Chất vải thun lạnh tho&aacute;ng m&aacute;t, thấm h&uacute;t mồ h&ocirc;i, tho&aacute;ng m&aacute;t khi mặc</li>\r\n	<li>Thoải m&aacute;i vận động với thiết kế trẻ trung năng động</li>\r\n</ul>', '<p><strong>Giặt đ&uacute;ng c&aacute;ch:</strong></p>\r\n\r\n<ul>\r\n	<li>Lộn tr&aacute;i quần &aacute;o trước khi giặt.</li>\r\n	<li>Giặt bằng nước lạnh, tr&aacute;nh d&ugrave;ng nước n&oacute;ng.</li>\r\n	<li>Kh&ocirc;ng giặt chung với quần &aacute;o dễ phai m&agrave;u.</li>\r\n	<li>Hạn chế d&ugrave;ng x&agrave; ph&ograve;ng mạnh, n&ecirc;n d&ugrave;ng nước giặt chuy&ecirc;n dụng hoặc pha lo&atilde;ng x&agrave; ph&ograve;ng.<br />\r\n	&nbsp;</li>\r\n</ul>\r\n\r\n<p><strong>Phơi đ&uacute;ng c&aacute;ch:</strong></p>\r\n\r\n<ul>\r\n	<li>Lộn tr&aacute;i khi phơi để bảo vệ m&agrave;u sắc v&agrave; h&igrave;nh in.</li>\r\n	<li>Phơi ở nơi tho&aacute;ng gi&oacute;, tr&aacute;nh &aacute;nh nắng trực tiếp1.</li>\r\n	<li>N&ecirc;n phơi theo kiểu vắt qua d&acirc;y hoặc d&ugrave;ng m&oacute;c treo c&oacute; bề mặt nhẵn mịn.<br />\r\n	&nbsp;</li>\r\n</ul>\r\n\r\n<p><strong>Cất giữ:</strong></p>\r\n\r\n<ul>\r\n	<li>Treo quần &aacute;o l&ecirc;n m&oacute;c để tr&aacute;nh nhăn v&agrave; giữ form d&aacute;ng.</li>\r\n	<li>Bảo quản ở nơi kh&ocirc; r&aacute;o, tho&aacute;ng m&aacute;t để tr&aacute;nh nấm mốc.</li>\r\n</ul>', '68db196b150b5.jpg', '68db196b154eb.png', 1),
(71, 'Áo bóng đá Arsenal trắng sân khách mẫu ba 25/26', 'MSP001', 1, 1, 10, 120000.00, 180000, 'Thân áo in chuyển nhiệt đẹp\r\nChất vải thun lạnh thoáng mát, thấm hút mồ hôi, thoáng mát khi mặc\r\nThoải mái vận động với thiết kế trẻ trung năng động', 'Giặt đúng cách:\r\n\r\nLộn trái quần áo trước khi giặt.\r\nGiặt bằng nước lạnh, tránh dùng nước nóng.\r\nKhông giặt chung với quần áo dễ phai màu.\r\nHạn chế dùng xà phòng mạnh, nên dùng nước giặt chuyên dụng hoặc pha loãng xà phòng.\r\n \r\nPhơi đúng cách:\r\n\r\nLộn trái khi phơi để bảo vệ màu sắc và hình in.\r\nPhơi ở nơi thoáng gió, tránh ánh nắng trực tiếp1.\r\nNên phơi theo kiểu vắt qua dây hoặc dùng móc treo có bề mặt nhẵn mịn.\r\n \r\nCất giữ:\r\n\r\nTreo quần áo lên móc để tránh nhăn và giữ form dáng.\r\nBảo quản ở nơi khô ráo, thoáng mát để tránh nấm mốc.', '68db1794c796f.png', '68db1794c7edf.png', 1),
(72, 'Áo bóng đá Arsenal đỏ sân nhà 25/26', 'msp002', 1, 1, 9, 100000.00, 120000, '<ul>\r\n	<li>Th&acirc;n &aacute;o in chuyển nhiệt đẹp</li>\r\n	<li>Chất vải thun lạnh tho&aacute;ng m&aacute;t, thấm h&uacute;t mồ h&ocirc;i, tho&aacute;ng m&aacute;t khi mặc</li>\r\n	<li>Thoải m&aacute;i vận động với thiết kế trẻ trung năng động</li>\r\n</ul>', '<p><strong>Giặt đ&uacute;ng c&aacute;ch:</strong></p>\r\n\r\n<ul>\r\n	<li>Lộn tr&aacute;i quần &aacute;o trước khi giặt.</li>\r\n	<li>Giặt bằng nước lạnh, tr&aacute;nh d&ugrave;ng nước n&oacute;ng.</li>\r\n	<li>Kh&ocirc;ng giặt chung với quần &aacute;o dễ phai m&agrave;u.</li>\r\n	<li>Hạn chế d&ugrave;ng x&agrave; ph&ograve;ng mạnh, n&ecirc;n d&ugrave;ng nước giặt chuy&ecirc;n dụng hoặc pha lo&atilde;ng x&agrave; ph&ograve;ng.<br />\r\n	&nbsp;</li>\r\n</ul>\r\n\r\n<p><strong>Phơi đ&uacute;ng c&aacute;ch:</strong></p>\r\n\r\n<ul>\r\n	<li>Lộn tr&aacute;i khi phơi để bảo vệ m&agrave;u sắc v&agrave; h&igrave;nh in.</li>\r\n	<li>Phơi ở nơi tho&aacute;ng gi&oacute;, tr&aacute;nh &aacute;nh nắng trực tiếp1.</li>\r\n	<li>N&ecirc;n phơi theo kiểu vắt qua d&acirc;y hoặc d&ugrave;ng m&oacute;c treo c&oacute; bề mặt nhẵn mịn.<br />\r\n	&nbsp;</li>\r\n</ul>\r\n\r\n<p><strong>Cất giữ:</strong></p>\r\n\r\n<ul>\r\n	<li>Treo quần &aacute;o l&ecirc;n m&oacute;c để tr&aacute;nh nhăn v&agrave; giữ form d&aacute;ng.</li>\r\n	<li>Bảo quản ở nơi kh&ocirc; r&aacute;o, tho&aacute;ng m&aacute;t để tr&aacute;nh nấm mốc.</li>\r\n</ul>', '68db1922be2e3.png', '68db1922bea52.png', 1),
(77, 'Áo Real Madrid trắng sân nhà 25/26', 'SPOREAMADT2', 1, 8, 10, 120000.00, 0, 'Chi tiết áo Real Madrid trắng hàng Việt Nam\r\n\r\nChất liệu: 100% Polyester – Thun lạnh co giản và thấm hút / Thoát mồ hôi tốt\r\nKiểu dáng: Regular Form – Form suông  châu Á\r\nSize: S – M – L – XL – 2XL\r\nLogo thêu chỉ chắc chắn, các hoạ tiết in chuyển sắc nét.', 'Giặt đúng cách:\r\n\r\nLộn trái quần áo trước khi giặt.\r\nGiặt bằng nước lạnh, tránh dùng nước nóng.\r\nKhông giặt chung với quần áo dễ phai màu.\r\nHạn chế dùng xà phòng mạnh, nên dùng nước giặt chuyên dụng hoặc pha loãng xà phòng.\r\n \r\nPhơi đúng cách:\r\n\r\nLộn trái khi phơi để bảo vệ màu sắc và hình in.\r\nPhơi ở nơi thoáng gió, tránh ánh nắng trực tiếp1.\r\nNên phơi theo kiểu vắt qua dây hoặc dùng móc treo có bề mặt nhẵn mịn.\r\n \r\nCất giữ:\r\n\r\nTreo quần áo lên móc để tránh nhăn và giữ form dáng.\r\nBảo quản ở nơi khô ráo, thoáng mát để tránh nấm mốc.', '68d76e73cd0b9.jpg', '68d76e73cd8e8.png', 1),
(78, 'Bộ quần áo bóng đá CLB Arsenal Đỏ sân nhà 2024-2025', 'SPBQUNOBNG45', 15, 17, 9, 150000.00, 190000, 'test', 'test', '68d77741bb81f.jpg', '68d77741bbc58.jpg', 0),
(79, 'Bộ quần áo bóng đá CLB Arsenal Đỏ sân nhà 2024-2025', 'SPBQUNOBNG54', 15, 17, 14, 150000.00, 200000, 'sdasd', 'adasdasd', '68d992745fd6a.jpg', '68d9927460a7d.jpg', 0),
(80, 'Bộ quần áo bóng đá CLB Arsenal Đỏ sân nhà 2024-2025', 'SPBQUNOBNG98', 15, 17, 12, 150000.00, 0, 'sdasdas', 'sadasds', '68d999f90cf69.jpg', '68d999f90d694.jpg', 0),
(81, 'Áo bóng đá Barca sọc sân nhà 25/26', 'SPBAR2526', 15, 17, 8, 150000.00, 200000, 'ÁDSAD', 'ADSADSAD', '68d99ba30d9e4.png', '68d99ba30e202.png', 1),
(82, 'Bộ quần áo bóng đá CLB Arsenal Đỏ sân nhà 2024-2025', 'SPBQUNOBNG49', 15, 17, 9, 145000.00, 0, 'đasads', 'adsafasf', '68d9a45dbed48.jpg', '68d9a45dbf4eb.jpg', 0),
(84, 'Áo bóng đá Arsenal xanh đen sân khách 25/26', 'SPOBNGARSX44', 1, 1, 8, 120000.00, 0, 'Chi tiết Áo thi đấu Arsenal sân khách mùa giải 25/26\r\n\r\nChất liệu: 100% Polyester – Thun lạnh co giản và thấm hút / Thoát mồ hôi tốt\r\nKiểu dáng: Regular Form – Form suông  châu Á\r\nSize: S – M – L – XL – 2XL\r\nLogo thêu chỉ chắc chắn, các hoạ tiết in chuyển sắc nét', 'Giặt đúng cách:\r\n\r\nLộn trái quần áo trước khi giặt.\r\nGiặt bằng nước lạnh, tránh dùng nước nóng.\r\nKhông giặt chung với quần áo dễ phai màu.\r\nHạn chế dùng xà phòng mạnh, nên dùng nước giặt chuyên dụng hoặc pha loãng xà phòng.\r\n \r\nPhơi đúng cách:\r\n\r\nLộn trái khi phơi để bảo vệ màu sắc và hình in.\r\nPhơi ở nơi thoáng gió, tránh ánh nắng trực tiếp1.\r\nNên phơi theo kiểu vắt qua dây hoặc dùng móc treo có bề mặt nhẵn mịn.\r\n \r\nCất giữ:\r\n\r\nTreo quần áo lên móc để tránh nhăn và giữ form dáng.\r\nBảo quản ở nơi khô ráo, thoáng mát để tránh nấm mốc.', '68db1a4259dd4.png', '68db1a425afee.png', 0),
(85, 'Áo bóng đá Liverpool đỏ sân nhà 25/26', 'SPOBNGLIVS56', 1, 1, 9, 120000.00, 150000, 'Chi tiết Áo thi đấu Liverpool đỏ sân nhà mùa giải 25/26\r\n\r\nChất liệu: 100% Polyester – Thun lạnh co giản và thấm hút / Thoát mồ hôi tốt\r\nKiểu dáng: Regular Form – Form suông  châu Á\r\nSize: S – M – L – XL – 2XL\r\nLogo thêu chỉ chắc chắn, các hoạ tiết in chuyển sắc nét.', 'Giặt đúng cách: Lộn trái quần áo trước khi giặt. Giặt bằng nước lạnh, tránh dùng nước nóng. Không giặt chung với quần áo dễ phai màu. Hạn chế dùng xà phòng mạnh, nên dùng nước giặt chuyên dụng hoặc pha loãng xà phòng. Phơi đúng cách: Lộn trái khi phơi để bảo vệ màu sắc và hình in. Phơi ở nơi thoáng gió, tránh ánh nắng trực tiếp1. Nên phơi theo kiểu vắt qua dây hoặc dùng móc treo có bề mặt nhẵn mịn. Cất giữ: Treo quần áo lên móc để tránh nhăn và giữ form dáng. Bảo quản ở nơi khô ráo, thoáng mát để tránh nấm mốc.', '68db1aeb51fce.jpg', '68db1aeb52739.png', 0),
(86, 'Áo bóng đá Liverpool trắng sân khách 25/26', 'SPOBNGLIVT12', 1, 1, 10, 150000.00, 0, 'Chi tiết Áo thi đấu Liverpool trắng sân khách mùa giải 25/26\r\n\r\nChất liệu: 100% Polyester – Thun lạnh co giản và thấm hút / Thoát mồ hôi tốt\r\nKiểu dáng: Regular Form – Form suông  châu Á\r\nSize: S – M – L – XL – 2XL\r\nLogo thêu chỉ chắc chắn, các hoạ tiết in chuyển sắc nét.', 'Giặt đúng cách:\r\n\r\nLộn trái quần áo trước khi giặt.\r\nGiặt bằng nước lạnh, tránh dùng nước nóng.\r\nKhông giặt chung với quần áo dễ phai màu.\r\nHạn chế dùng xà phòng mạnh, nên dùng nước giặt chuyên dụng hoặc pha loãng xà phòng.\r\n \r\nPhơi đúng cách:\r\n\r\nLộn trái khi phơi để bảo vệ màu sắc và hình in.\r\nPhơi ở nơi thoáng gió, tránh ánh nắng trực tiếp1.\r\nNên phơi theo kiểu vắt qua dây hoặc dùng móc treo có bề mặt nhẵn mịn.\r\n \r\nCất giữ:\r\n\r\nTreo quần áo lên móc để tránh nhăn và giữ form dáng.\r\nBảo quản ở nơi khô ráo, thoáng mát để tránh nấm mốc.', '68db1b3722aed.png', '68db1b37230ce.png', 0),
(87, 'Áo bóng đá MU đỏ sân nhà 25/26', 'SPOBNGMUSN28', 1, 1, 9, 120000.00, 150000, 'Chi tiết áo MU đỏ mùa giải 25/26\r\n\r\nChất liệu: 100% Polyester – Thun lạnh co giản và thấm hút / Thoát mồ hôi tốt\r\nKiểu dáng: Regular Form – Form suông  châu Á\r\nSize: S – M – L – XL – 2XL\r\nLogo thêu chỉ chắc chắn, các hoạ tiết in chuyển sắc nét.', 'Giặt đúng cách:\r\n\r\nLộn trái quần áo trước khi giặt.\r\nGiặt bằng nước lạnh, tránh dùng nước nóng.\r\nKhông giặt chung với quần áo dễ phai màu.\r\nHạn chế dùng xà phòng mạnh, nên dùng nước giặt chuyên dụng hoặc pha loãng xà phòng.\r\n \r\nPhơi đúng cách:\r\n\r\nLộn trái khi phơi để bảo vệ màu sắc và hình in.\r\nPhơi ở nơi thoáng gió, tránh ánh nắng trực tiếp1.\r\nNên phơi theo kiểu vắt qua dây hoặc dùng móc treo có bề mặt nhẵn mịn.\r\n \r\nCất giữ:\r\n\r\nTreo quần áo lên móc để tránh nhăn và giữ form dáng.\r\nBảo quản ở nơi khô ráo, thoáng mát để tránh nấm mốc.', '68db1c17058cd.png', '68db1c1705e59.png', 1),
(88, 'Áo bóng đá Chelsea xanh sân nhà 25/26', 'SPOBNGCHEX4', 1, 1, 8, 120000.00, 0, 'Chi tiết áo Chelsea xanh mùa giải 25/26\r\n\r\nChất liệu: 100% Polyester – Thun lạnh co giản và thấm hút / Thoát mồ hôi tốt\r\nKiểu dáng: Regular Form – Form suông  châu Á\r\nSize: S – M – L – XL – 2XL\r\nLogo thêu chỉ chắc chắn, các hoạ tiết in chuyển sắc nét.', 'Giặt đúng cách:\r\n\r\nLộn trái quần áo trước khi giặt.\r\nGiặt bằng nước lạnh, tránh dùng nước nóng.\r\nKhông giặt chung với quần áo dễ phai màu.\r\nHạn chế dùng xà phòng mạnh, nên dùng nước giặt chuyên dụng hoặc pha loãng xà phòng.\r\n \r\nPhơi đúng cách:\r\n\r\nLộn trái khi phơi để bảo vệ màu sắc và hình in.\r\nPhơi ở nơi thoáng gió, tránh ánh nắng trực tiếp1.\r\nNên phơi theo kiểu vắt qua dây hoặc dùng móc treo có bề mặt nhẵn mịn.\r\n \r\nCất giữ:\r\n\r\nTreo quần áo lên móc để tránh nhăn và giữ form dáng.\r\nBảo quản ở nơi khô ráo, thoáng mát để tránh nấm mốc.', '68db1c5c22d28.png', '68db1c5c23623.png', 0),
(89, 'Bộ quần áo bóng đá CLB Arsenal Đỏ sân nhà 2024-2025', 'SPBQUNOBNG32', 15, 17, 10, 120000.00, 0, 'fsdfsdf', 'dsfsdf', '68db28f8b6776.jpg', '68db28f8b6d37.jpg', 0),
(90, 'Áo Real Madrid xanh sân khách mẫu ba 25/26', 'SPOREAMADX2', 1, 8, 8, 120000.00, 150000, 'Chi tiết áo Chelsea xanh mùa giải 25/26 Chất liệu: 100% Polyester – Thun lạnh co giản và thấm hút / Thoát mồ hôi tốt Kiểu dáng: Regular Form – Form suông châu Á Size: S – M – L – XL – 2XL Logo thêu chỉ chắc chắn, các hoạ tiết in chuyển sắc nét.', 'Giặt đúng cách: Lộn trái quần áo trước khi giặt. Giặt bằng nước lạnh, tránh dùng nước nóng. Không giặt chung với quần áo dễ phai màu. Hạn chế dùng xà phòng mạnh, nên dùng nước giặt chuyên dụng hoặc pha loãng xà phòng. Phơi đúng cách: Lộn trái khi phơi để bảo vệ màu sắc và hình in. Phơi ở nơi thoáng gió, tránh ánh nắng trực tiếp1. Nên phơi theo kiểu vắt qua dây hoặc dùng móc treo có bề mặt nhẵn mịn. Cất giữ: Treo quần áo lên móc để tránh nhăn và giữ form dáng. Bảo quản ở nơi khô ráo, thoáng mát để tránh nấm mốc.', '68dbd23435b4c.jpg', '68dbd2343650d.png', 0),
(91, 'Áo bóng đá Barca sân nhà 25/26 hàng Thái Lan', 'SPOBNGBARS29', 1, 8, 8, 230000.00, 250000, 'Không sử dụng chất tẩy\r\nKhông sấy khô\r\nKhông giặt khô\r\nỦi với nhiệt độ thấp, dưới 40 độ C\r\nGiặt bằng nước lạnh', 'Bảng size tư vấn mang tình chất tham khảo dựa trên chiều cao và cân nặng chuẩn của người mẫu mặc trên cơ thể. Để được tư vấn chính xác hơn bạn có thể nhắn tin trực tiếp Sporter để được tư vấn kỹ hơn về bảng size hoặc ghé trực tiếp Sporter để thử size và mua trực tiếp nhé.', '68dc02e9388fe.png', '68dc02e939ab0.png', 0);
...
(294, 77, '68d76e0a908be.jpg'),
(295, 77, '68d76e0a91722.png'),
(296, 78, '68d77741bd5a9.jpg'),
(297, 78, '68d77741be095.jpg'),
(298, 78, '68d77741bebba.jpg'),
(299, 78, '68d77741bf5a9.jpg'),
(300, 81, '68d99ba310bd3.png'),
(301, 81, '68d99ba31198a.png'),
(302, 81, '68d99ba31263b.png'),
(303, 81, '68d99ba313351.png'),
(304, 71, '68db174d12cc2.png'),
(305, 71, '68db174d13803.png'),
(306, 71, '68db174d142ab.png'),
(307, 71, '68db174d14e6c.png'),
(308, 72, '68db1922c75ef.png'),
(309, 72, '68db1922c851a.png'),
(310, 72, '68db1922c9249.png'),
(311, 72, '68db1922ca032.png'),
(312, 43, '68db196b1ef8a.jpg'),
(313, 43, '68db196b1fca7.png'),
(314, 43, '68db196b20883.jpg'),
(315, 43, '68db196b2139d.png'),
(316, 84, '68db1a4261acd.png'),
(317, 84, '68db1a42625eb.png'),
(318, 85, '68db1aeb55ea8.jpg'),
(319, 85, '68db1aeb56a82.jpg'),
(320, 85, '68db1aeb57810.png'),
(321, 85, '68db1aeb58837.png'),
(322, 86, '68db1b3726f5b.png'),
(323, 86, '68db1b3727bd6.png'),
(324, 86, '68db1b372888b.png'),
(325, 86, '68db1b3729791.png'),
(326, 87, '68db1c1709d27.png'),
(327, 87, '68db1c170adc3.png'),
(328, 87, '68db1c170bae1.png'),
(329, 87, '68db1c170c7c7.png'),
(330, 88, '68db1c5c25ca2.png'),
(331, 88, '68db1c5c26a4b.png'),
(332, 88, '68db1c5c27531.png'),
(333, 90, '68dbd2343bb39.png'),
(334, 90, '68dbd2343ce38.png'),
(335, 90, '68dbd2343dbfb.jpg'),
(336, 90, '68dbd2343e80b.jpg'),
(337, 91, '68dc02e93f6d5.png'),
(338, 91, '68dc02e9405f4.png'),
(339, 91, '68dc02e941722.png'),
(340, 91, '68dc02e942c95.png');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tbl_sanpham_bienthe`
--

CREATE TABLE `tbl_sanpham_bienthe` (
  `bienthe_id` int(11) NOT NULL,
  `sanpham_id` int(11) NOT NULL,
  `color_id` int(11) NOT NULL,
  `sanpham_size_id` int(11) NOT NULL,
  `soluong` int(11) NOT NULL DEFAULT 0,
  `bienthe_ma` varchar(50) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Đang đổ dữ liệu cho bảng `tbl_sanpham_bienthe`
--

INSERT INTO `tbl_sanpham_bienthe` (`bienthe_id`, `sanpham_id`, `color_id`, `sanpham_size_id`, `soluong`, `bienthe_ma`, `created_at`, `updated_at`) VALUES
(1, 80, 12, 262, 0, 'SPBQUNOBNG98-CA-L', '2025-09-28 20:26:33', '2025-09-28 20:26:33'),
(2, 81, 8, 263, 0, 'SPBAR2526-XA-S', '2025-09-28 20:33:39', '2025-09-28 20:33:39'),
(3, 81, 8, 264, 0, 'SPBAR2526-XA-M', '2025-09-28 20:33:39', '2025-09-28 20:33:39'),
(4, 81, 8, 265, 0, 'SPBAR2526-XA-L', '2025-09-28 20:33:39', '2025-09-28 20:33:39'),
(5, 81, 8, 266, 0, 'SPBAR2526-XA-XL', '2025-09-28 20:33:39', '2025-09-28 20:33:39'),
(7, 82, 9, 268, 0, 'SPBQUNOBNG49-Đ-L', '2025-09-28 21:10:53', '2025-09-28 21:10:53'),
(8, 82, 9, 269, 0, 'SPBQUNOBNG49-Đ-XL', '2025-09-28 21:10:53', '2025-09-28 21:10:53'),
(10, 81, 8, 267, 50, 'SPBAR2526-XA-XXL', '2025-09-28 21:43:10', '2025-09-28 21:43:10'),
(39, 71, 10, 298, 0, 'MSP001-TR-S', '2025-09-29 23:34:44', '2025-09-29 23:34:44'),
(40, 71, 10, 299, 0, 'MSP001-TR-M', '2025-09-29 23:34:44', '2025-09-29 23:34:44'),
(41, 71, 10, 300, 0, 'MSP001-TR-L', '2025-09-29 23:34:44', '2025-09-29 23:34:44'),
(42, 71, 10, 301, 0, 'MSP001-TR-XL', '2025-09-29 23:34:44', '2025-09-29 23:34:44'),
(43, 71, 10, 302, 0, 'MSP001-TR-XXL', '2025-09-29 23:34:44', '2025-09-29 23:34:44'),
(44, 72, 9, 303, 0, 'msp002-Đ-S', '2025-09-29 23:41:22', '2025-09-29 23:41:22'),
(45, 72, 9, 304, 0, 'msp002-Đ-M', '2025-09-29 23:41:22', '2025-09-29 23:41:22'),
(46, 72, 9, 305, 0, 'msp002-Đ-L', '2025-09-29 23:41:22', '2025-09-29 23:41:22'),
(47, 72, 9, 306, 0, 'msp002-Đ-XL', '2025-09-29 23:41:22', '2025-09-29 23:41:22'),
(48, 72, 9, 307, 0, 'msp002-Đ-XXL', '2025-09-29 23:41:22', '2025-09-29 23:41:22'),
(49, 43, 8, 308, 0, 'VFO0001-XA-S', '2025-09-29 23:42:35', '2025-09-29 23:42:35'),
(50, 43, 8, 309, 0, 'VFO0001-XA-M', '2025-09-29 23:42:35', '2025-09-29 23:42:35'),
(51, 43, 8, 310, 0, 'VFO0001-XA-L', '2025-09-29 23:42:35', '2025-09-29 23:42:35'),
(52, 43, 8, 311, 0, 'VFO0001-XA-XL', '2025-09-29 23:42:35', '2025-09-29 23:42:35'),
(53, 43, 8, 312, 0, 'VFO0001-XA-XXL', '2025-09-29 23:42:35', '2025-09-29 23:42:35'),
(54, 84, 8, 313, 0, 'SPOBNGARSX44-XA-S', '2025-09-29 23:46:10', '2025-09-29 23:46:10'),
(55, 84, 8, 314, 0, 'SPOBNGARSX44-XA-M', '2025-09-29 23:46:10', '2025-09-29 23:46:10'),
(56, 84, 8, 315, 0, 'SPOBNGARSX44-XA-L', '2025-09-29 23:46:10', '2025-09-29 23:46:10'),
(57, 84, 8, 316, 0, 'SPOBNGARSX44-XA-XL', '2025-09-29 23:46:10', '2025-09-29 23:46:10'),
(58, 84, 8, 317, 0, 'SPOBNGARSX44-XA-XXL', '2025-09-29 23:46:10', '2025-09-29 23:46:10'),
(59, 85, 9, 318, 0, 'SPOBNGLIVS56-Đ-S', '2025-09-29 23:48:59', '2025-09-29 23:48:59'),
(60, 85, 9, 319, 0, 'SPOBNGLIVS56-Đ-M', '2025-09-29 23:48:59', '2025-09-29 23:48:59'),
(61, 85, 9, 320, 0, 'SPOBNGLIVS56-Đ-L', '2025-09-29 23:48:59', '2025-09-29 23:48:59'),
(62, 85, 9, 321, 0, 'SPOBNGLIVS56-Đ-XL', '2025-09-29 23:48:59', '2025-09-29 23:48:59'),
(63, 85, 9, 322, 0, 'SPOBNGLIVS56-Đ-XXL', '2025-09-29 23:48:59', '2025-09-29 23:48:59'),
(64, 86, 10, 323, 0, 'SPOBNGLIVT12-TR-S', '2025-09-29 23:50:15', '2025-09-29 23:50:15'),
(65, 86, 10, 324, 0, 'SPOBNGLIVT12-TR-M', '2025-09-29 23:50:15', '2025-09-29 23:50:15'),
(66, 86, 10, 325, 0, 'SPOBNGLIVT12-TR-L', '2025-09-29 23:50:15', '2025-09-29 23:50:15'),
(67, 86, 10, 326, 0, 'SPOBNGLIVT12-TR-XL', '2025-09-29 23:50:15', '2025-09-29 23:50:15'),
(68, 86, 10, 327, 0, 'SPOBNGLIVT12-TR-XXL', '2025-09-29 23:50:15', '2025-09-29 23:50:15'),
(69, 87, 9, 328, 0, 'SPOBNGMUSN28-Đ-S', '2025-09-29 23:53:59', '2025-09-29 23:53:59'),
(70, 87, 9, 329, 0, 'SPOBNGMUSN28-Đ-M', '2025-09-29 23:53:59', '2025-09-29 23:53:59'),
(71, 87, 9, 330, 0, 'SPOBNGMUSN28-Đ-L', '2025-09-29 23:53:59', '2025-09-29 23:53:59'),
(72, 87, 9, 331, 0, 'SPOBNGMUSN28-Đ-XL', '2025-09-29 23:53:59', '2025-09-29 23:53:59'),
(73, 87, 9, 332, 0, 'SPOBNGMUSN28-Đ-XXL', '2025-09-29 23:53:59', '2025-09-29 23:53:59'),
(74, 88, 8, 333, 0, 'SPOBNGCHEX4-XA-S', '2025-09-29 23:55:08', '2025-09-29 23:55:08'),
(75, 88, 8, 334, 0, 'SPOBNGCHEX4-XA-M', '2025-09-29 23:55:08', '2025-09-29 23:55:08'),
(76, 88, 8, 335, 0, 'SPOBNGCHEX4-XA-L', '2025-09-29 23:55:08', '2025-09-29 23:55:08'),
(77, 88, 8, 336, 0, 'SPOBNGCHEX4-XA-XL', '2025-09-29 23:55:08', '2025-09-29 23:55:08'),
(78, 88, 8, 337, 0, 'SPOBNGCHEX4-XA-XXL', '2025-09-29 23:55:08', '2025-09-29 23:55:08'),
(79, 89, 10, 338, 0, 'SPBQUNOBNG32-TR-L', '2025-09-30 00:48:56', '2025-09-30 00:48:56'),
(80, 90, 8, 339, 0, 'SPOREAMADX2-XA-S', '2025-09-30 12:51:00', '2025-09-30 12:51:00'),
(81, 90, 8, 340, 0, 'SPOREAMADX2-XA-M', '2025-09-30 12:51:00', '2025-09-30 12:51:00'),
(82, 90, 8, 341, 0, 'SPOREAMADX2-XA-L', '2025-09-30 12:51:00', '2025-09-30 12:51:00'),
(83, 90, 8, 342, 0, 'SPOREAMADX2-XA-XL', '2025-09-30 12:51:00', '2025-09-30 12:51:00'),
(84, 90, 8, 343, 0, 'SPOREAMADX2-XA-XXL', '2025-09-30 12:51:00', '2025-09-30 12:51:00'),
(85, 91, 8, 344, 0, 'SPOBNGBARS29-XA-S', '2025-09-30 16:18:49', '2025-09-30 16:18:49'),
(86, 91, 8, 345, 0, 'SPOBNGBARS29-XA-M', '2025-09-30 16:18:49', '2025-09-30 16:18:49'),
(87, 91, 8, 346, 0, 'SPOBNGBARS29-XA-L', '2025-09-30 16:18:49', '2025-09-30 16:18:49'),
(88, 91, 8, 347, 0, 'SPOBNGBARS29-XA-XL', '2025-09-30 16:18:49', '2025-09-30 16:18:49'),
(89, 91, 8, 348, 0, 'SPOBNGBARS29-XA-XXL', '2025-09-30 16:18:49', '2025-09-30 16:18:49');
...
CREATE TABLE `tbl_tonkho` (
  ...
  `bienthe_id` int(11) NOT NULL,
  `soluong_ton` int(11) NOT NULL DEFAULT 0,
  `soluong_dat` int(11) NOT NULL DEFAULT 0,
  `soluong_co_the_ban` int(11) GENERATED ALWAYS AS (`soluong_ton` - `soluong_dat`) VIRTUAL,
  `muc_canh_bao` int(11) NOT NULL DEFAULT 10,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Đang đổ dữ liệu cho bảng `tbl_tonkho`
--

INSERT INTO `tbl_tonkho` (`tonkho_id`, `bienthe_id`, `soluong_ton`, `soluong_dat`, `muc_canh_bao`, `created_at`, `updated_at`) VALUES
(1, 1, 98, 0, 10, '2025-09-28 20:26:33', '2025-09-30 12:05:54'),
(2, 2, 50, 0, 10, '2025-09-28 20:33:39', '2025-09-28 20:57:46'),
(3, 3, 120, 0, 10, '2025-09-28 20:33:39', '2025-09-28 20:57:53'),
(4, 4, 130, 44, 10, '2025-09-28 20:33:39', '2025-09-28 22:22:10'),
(5, 5, 234, 54, 10, '2025-09-28 20:33:39', '2025-09-28 20:58:19'),
(7, 7, 100, 1, 10, '2025-09-28 21:10:53', '2025-09-30 00:14:19'),
(8, 8, 149, 0, 10, '2025-09-28 21:10:53', '2025-09-29 22:35:43'),
(10, 10, 49, 0, 10, '2025-09-28 21:43:10', '2025-09-29 22:19:31'),
(39, 39, 100, 0, 10, '2025-09-29 23:34:44', '2025-09-29 23:58:36'),
(40, 40, 100, 0, 10, '2025-09-29 23:34:44', '2025-09-29 23:58:36'),
(41, 41, 100, 0, 10, '2025-09-29 23:34:44', '2025-09-29 23:58:35'),
(42, 42, 100, 0, 10, '2025-09-29 23:34:44', '2025-09-29 23:58:37'),
(43, 43, 100, 0, 10, '2025-09-29 23:34:44', '2025-09-29 23:58:38'),
(44, 44, 100, 0, 10, '2025-09-29 23:41:22', '2025-09-29 23:59:31'),
(45, 45, 99, 0, 10, '2025-09-29 23:41:22', '2025-09-30 12:11:04'),
(46, 46, 100, 0, 10, '2025-09-29 23:41:22', '2025-09-29 23:59:29'),
(47, 47, 100, 0, 10, '2025-09-29 23:41:22', '2025-09-29 23:59:28'),
(48, 48, 100, 0, 10, '2025-09-29 23:41:22', '2025-09-29 23:59:27'),
(49, 49, 100, 0, 10, '2025-09-29 23:42:35', '2025-09-30 00:03:12'),
(50, 50, 99, 0, 10, '2025-09-29 23:42:35', '2025-09-30 05:14:40'),
(51, 51, 100, 0, 10, '2025-09-29 23:42:35', '2025-09-30 00:03:11'),
(52, 52, 100, 0, 10, '2025-09-29 23:42:35', '2025-09-30 00:03:10'),
(53, 53, 100, 0, 10, '2025-09-29 23:42:35', '2025-09-30 00:03:09'),
(54, 54, 100, 0, 10, '2025-09-29 23:46:10', '2025-09-29 23:59:05'),
(55, 55, 99, 0, 10, '2025-09-29 23:46:10', '2025-09-30 06:10:43'),
(56, 56, 100, 0, 10, '2025-09-29 23:46:10', '2025-09-29 23:59:04'),
(57, 57, 100, 0, 10, '2025-09-29 23:46:10', '2025-09-29 23:59:03'),
(58, 58, 100, 0, 10, '2025-09-29 23:46:10', '2025-09-29 23:59:02'),
(59, 59, 100, 0, 10, '2025-09-29 23:48:59', '2025-09-30 00:02:41'),
(60, 60, 99, 0, 10, '2025-09-29 23:48:59', '2025-09-30 13:00:40'),
(61, 61, 100, 0, 10, '2025-09-29 23:48:59', '2025-09-30 00:02:40'),
(62, 62, 100, 0, 10, '2025-09-29 23:48:59', '2025-09-30 00:02:39'),
(63, 63, 100, 0, 10, '2025-09-29 23:48:59', '2025-09-30 00:02:38'),
(64, 64, 100, 0, 10, '2025-09-29 23:50:15', '2025-09-30 00:01:58'),
(65, 65, 97, 0, 10, '2025-09-29 23:50:15', '2025-09-30 16:08:09'),
(66, 66, 100, 0, 10, '2025-09-29 23:50:15', '2025-09-30 00:01:57'),
(67, 67, 100, 0, 10, '2025-09-29 23:50:15', '2025-09-30 00:01:56'),
(68, 68, 100, 0, 10, '2025-09-29 23:50:15', '2025-09-30 00:01:55'),
(69, 69, 100, 0, 10, '2025-09-29 23:53:59', '2025-09-30 00:01:12'),
(70, 70, 97, 0, 10, '2025-09-29 23:53:59', '2025-09-30 16:08:09'),
(71, 71, 99, 0, 10, '2025-09-29 23:53:59', '2025-09-30 05:56:20'),
(72, 72, 100, 0, 10, '2025-09-29 23:53:59', '2025-09-30 00:01:09'),
(73, 73, 100, 0, 10, '2025-09-29 23:53:59', '2025-09-30 00:01:08'),
(74, 74, 100, 0, 10, '2025-09-29 23:55:08', '2025-09-30 00:00:06'),
(75, 75, 94, 0, 10, '2025-09-29 23:55:08', '2025-09-30 16:10:37'),
(76, 76, 100, 0, 10, '2025-09-29 23:55:08', '2025-09-30 00:00:08'),
(77, 77, 99, 0, 10, '2025-09-29 23:55:08', '2025-09-30 05:15:25'),
(78, 78, 100, 0, 10, '2025-09-29 23:55:08', '2025-09-30 00:00:04'),
(79, 79, 11, 0, 10, '2025-09-30 00:48:56', '2025-09-30 00:49:20'),
(80, 80, 0, 0, 10, '2025-09-30 12:51:00', '2025-09-30 12:51:00'),
(81, 81, 0, 0, 10, '2025-09-30 12:51:00', '2025-09-30 12:51:00'),
(82, 82, 0, 0, 10, '2025-09-30 12:51:00', '2025-09-30 12:51:00'),
(83, 83, 0, 0, 10, '2025-09-30 12:51:00', '2025-09-30 12:51:00'),
(84, 84, 0, 0, 10, '2025-09-30 12:51:00', '2025-09-30 12:51:00'),
(85, 85, 100, 1, 10, '2025-09-30 16:18:49', '2025-09-30 16:34:08'),
(86, 86, 100, 0, 10, '2025-09-30 16:18:49', '2025-09-30 16:20:09'),
(87, 87, 100, 0, 10, '2025-09-30 16:18:49', '2025-09-30 16:20:08'),
(88, 88, 100, 0, 10, '2025-09-30 16:18:49', '2025-09-30 16:20:08'),
(89, 89, 100, 0, 10, '2025-09-30 16:18:49', '2025-09-30 16:20:07');
...
ALTER TABLE `tbl_cart`
  ...
  ADD KEY `idx_customer_session` (`customer_id`,`session_idA`),
  ADD KEY `fk_cart_variant` (`bienthe_id`);
...
--
-- Chỉ mục cho bảng `tbl_momo_transaction_log`
--
ALTER TABLE `tbl_momo_transaction_log`
...
ALTER TABLE `tbl_order_details`
  ...
  ADD KEY `fk_order_details_variant` (`bienthe_id`);

--
-- Chỉ mục cho bảng `tbl_order_status_history`
--
...
--
-- Chỉ mục cho bảng `tbl_sanpham_bienthe`
--
ALTER TABLE `tbl_sanpham_bienthe`
  ADD PRIMARY KEY (`bienthe_id`),
  ADD UNIQUE KEY `uq_bienthe_sku` (`bienthe_ma`),
  ADD UNIQUE KEY `uq_sanpham_color_size` (`sanpham_id`,`color_id`,`sanpham_size_id`),
  ADD KEY `idx_sanpham_id` (`sanpham_id`),
  ADD KEY `idx_color_id` (`color_id`),
  ADD KEY `idx_size_id` (`sanpham_size_id`),
  ADD KEY `idx_soluong` (`soluong`);
...
ALTER TABLE `tbl_tonkho`
  ADD PRIMARY KEY (`tonkho_id`),
  ADD UNIQUE KEY `uq_bienthe_tonkho` (`bienthe_id`),
  ADD KEY `idx_soluong_ton` (`soluong_ton`),
  ADD KEY `idx_soluong_dat` (`soluong_dat`),
  ADD KEY `idx_muc_canh_bao` (`muc_canh_bao`);
...
--
ALTER TABLE `tbl_cart`
  MODIFY `cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=332;

--
-- AUTO_INCREMENT cho bảng `tbl_carta`
--
ALTER TABLE `tbl_carta`
  MODIFY `cartA_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
--
ALTER TABLE `tbl_danhmuc`
  MODIFY `danhmuc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT cho bảng `tbl_loaisanpham`
--
ALTER TABLE `tbl_loaisanpham`
  MODIFY `loaisanpham_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT cho bảng `tbl_momo_transaction_log`
--
ALTER TABLE `tbl_momo_transaction_log`
...
--
-- AUTO_INCREMENT cho bảng `tbl_order_status_history`
--
ALTER TABLE `tbl_order_status_history`
...
--
ALTER TABLE `tbl_sanpham_anh`
  MODIFY `sanpham_anh_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=341;

--
-- AUTO_INCREMENT cho bảng `tbl_sanpham_bienthe`
--
ALTER TABLE `tbl_sanpham_bienthe`
  MODIFY `bienthe_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT cho bảng `tbl_sanpham_size`
--
ALTER TABLE `tbl_sanpham_size`
  MODIFY `sanpham_size_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=349;

--
-- AUTO_INCREMENT cho bảng `tbl_tonkho`
--
ALTER TABLE `tbl_tonkho`
  MODIFY `tonkho_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
...
--
ALTER TABLE `tbl_cart`
  ADD CONSTRAINT `fk_cart_variant` FOREIGN KEY (`bienthe_id`) REFERENCES `tbl_sanpham_bienthe` (`bienthe_id`);

--
-- Các ràng buộc cho bảng `tbl_momo_transaction_log`
--
ALTER TABLE `tbl_momo_transaction_log`
  ADD CONSTRAINT `fk_momo_log_payment` FOREIGN KEY (`payment_id`) REFERENCES `tbl_payment` (`payment_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `tbl_order_details`
  ADD CONSTRAINT `fk_od_sp` FOREIGN KEY (`sanpham_id`) REFERENCES `tbl_sanpham` (`sanpham_id`),
  ADD CONSTRAINT `fk_order_details_order` FOREIGN KEY (`order_id`) REFERENCES `tbl_order` (`order_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_order_details_variant` FOREIGN KEY (`bienthe_id`) REFERENCES `tbl_sanpham_bienthe` (`bienthe_id`);

--
-- Các ràng buộc cho bảng `tbl_order_status_history`
--
ALTER TABLE `tbl_order_status_history`
  ADD CONSTRAINT `tbl_order_status_history_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `tbl_order` (`order_id`) ON DELETE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_payment`
--
ALTER TABLE `tbl_payment`
  ADD CONSTRAINT `fk_payment_order` FOREIGN KEY (`order_id`) REFERENCES `tbl_order` (`order_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_sanpham`
--
ALTER TABLE `tbl_sanpham`
  ADD CONSTRAINT `fk_sp_color` FOREIGN KEY (`color_id`) REFERENCES `tbl_color` (`color_id`),
  ADD CONSTRAINT `fk_sp_dm` FOREIGN KEY (`danhmuc_id`) REFERENCES `tbl_danhmuc` (`danhmuc_id`),
  ADD CONSTRAINT `fk_sp_loai` FOREIGN KEY (`loaisanpham_id`) REFERENCES `tbl_loaisanpham` (`loaisanpham_id`);

--
-- Các ràng buộc cho bảng `tbl_sanpham_anh`
--
ALTER TABLE `tbl_sanpham_anh`
  ADD CONSTRAINT `fk_sp_anh_sp` FOREIGN KEY (`sanpham_id`) REFERENCES `tbl_sanpham` (`sanpham_id`) ON DELETE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_sanpham_bienthe`
--
ALTER TABLE `tbl_sanpham_bienthe`
  ADD CONSTRAINT `fk_bienthe_color` FOREIGN KEY (`color_id`) REFERENCES `tbl_color` (`color_id`),
  ADD CONSTRAINT `fk_bienthe_sanpham` FOREIGN KEY (`sanpham_id`) REFERENCES `tbl_sanpham` (`sanpham_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_bienthe_size` FOREIGN KEY (`sanpham_size_id`) REFERENCES `tbl_sanpham_size` (`sanpham_size_id`) ON DELETE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_sanpham_size`
--
ALTER TABLE `tbl_sanpham_size`
  ADD CONSTRAINT `fk_sp_size_sp` FOREIGN KEY (`sanpham_id`) REFERENCES `tbl_sanpham` (`sanpham_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_tonkho`
--
ALTER TABLE `tbl_tonkho`
  ADD CONSTRAINT `fk_tonkho_bienthe` FOREIGN KEY (`bienthe_id`) REFERENCES `tbl_sanpham_bienthe` (`bienthe_id`) ON DELETE CASCADE;
COMMIT;
